            ...
            <Table>
              <TableHead>
                <TableRow sx={{ bgcolor: "#f5f7fa", borderRadius: 0 }}>
                  ...
                  >
                    <PersonIcon sx={{ mr: 1, color: "#111", fontSize: 22 }} />{" "}
                    Author
                  </TableCell>
                  <TableCell
                    align="left"
                  ...
                  >
                    <SettingsIcon sx={{ mr: 1, color: "#111", fontSize: 22 }} />{" "}
                    Actions
                  </TableCell>
                </TableRow>
              </TableHead>
            ...
            <DialogContent dividers={false} sx={{ pt: 2 }}>
              {detailModal.post ? (
                <Box>
                  ...
                  >
                    By:{" "}
                    {detailModal.post.user?.first_name ||
                    detailModal.post.user?.last_name
                      ? `${detailModal.post.user?.first_name || ""} ${
                          detailModal.post.user?.last_name || ""
                        }`.trim()
                      : detailModal.post.first_name ||
                        detailModal.post.last_name
                      ? `${detailModal.post.first_name || ""} ${
                          detailModal.post.last_name || ""
                        }`.trim()
                      : detailModal.post.author ||
                        detailModal.post.username ||
                        detailModal.post.user?.username ||
                        ""}
                  </Typography>
                  <Typography variant="body2" color="text.secondary">
                    Created:{" "}
                    {detailModal.post.created ||
                      detailModal.post.created_at ||
                      ""}
                  </Typography>
                  <Typography
                    variant="body2"
                    ...
                    sx={{ mb: 2 }}
                  >
                    Status: {detailModal.post.status}
                  </Typography>
                  <Divider sx={{ my: 2 }} />
                  ...
                  {(detailModal.post.status === "PENDING" ||
                    detailModal.post.status === "UPDATING") && (
                    <Box mt={3}>
                      <TextField
                      ...
                      <DialogActions>
                        <Button
                          onClick={() => handleApproveInModal(false)}
                          color="error"
                          variant="contained"
                          disabled={actionLoading === detailModal.post.id}
                        >
                          Reject
                        </Button>
                        <Button
                          onClick={() => handleApproveInModal(true)}
                          color="success"
                          variant="contained"
                          disabled={actionLoading === detailModal.post.id}
                        >
